...
def  ssh_cmd(task_log_obj):
    host = task_log_obj.bind_host.host.server
    ...
    try:
        ...
        ssh.connect(host.manage_ip, host.port, user_obj.username, user_obj.password,timeout=10)
...
def file_transfer(task_log_obj):
    ...
    try:
        ...
        t = paramiko.Transport((host.manage_ip, host.port))
