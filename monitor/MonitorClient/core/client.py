...
class ClientHandle(object):
    ...
    def url_request(self,action,url,**extra_data):
        ...
        if action in  ('get','GET'):
            ...
            try:
                req = urllib.Request(abs_url)
                req_data = urllib.urlopen(req,timeout=settings.configs['RequestTimeout'])
            ...
            try:
                ...
                res_data = urllib.urlopen(req,timeout=settings.configs['RequestTimeout'])
